 ...
 * @author NIDULA
 */
public class CashierSignIn1 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (un.isBlank()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `user` WHERE `username` = '" + un + "' AND `password` = '" + password + "' AND `user_type_id` = 4;");
                if (rs.next()) {
    ...
    static private CashierSignIn1 cs = SelectSignin.cs;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierSignIn1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
