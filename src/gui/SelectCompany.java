...
public class SelectCompany extends javax.swing.JDialog {
     ...
     */
    public SelectCompany(java.awt.Frame parent, boolean modal, CompanyBranches cb) {
        super(parent, modal);
        initComponents();
        searchCompanies();
        this.cb = cb;
    ...
    public SelectCompany(java.awt.Frame parent, boolean modal, AddSuppliers as) {
        super(parent, modal);
        initComponents();
        searchCompanies();
        this.as = as;
...
//        System.out.println(query);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Select Companies");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (selectedRow != -1) {
                if (cb != null) {
                    this.cb.jLabel12.setText(jTable1.getValueAt(selectedRow, 0).toString());
                    this.cb.jLabel14.setText(jTable1.getValueAt(selectedRow, 1).toString());
                } else if (as != null) {
                    this.as.jLabel26.setText(jTable1.getValueAt(selectedRow, 0).toString());
                    this.as.jLabel28.setText(jTable1.getValueAt(selectedRow, 1).toString());
                    this.as.jLabel30.setText("");
                    this.as.jLabel32.setText("");
