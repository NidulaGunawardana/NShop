...
public class AddCategory extends javax.swing.JDialog {
    ...
    public AddCategory(java.awt.Frame parent, boolean modal, AddProducts ap) {
        super(parent, modal);
        initComponents();
        jTable1.getTableHeader().setFont(new Font("Segoe UI", Font.PLAIN, 18));
        loadCategory();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (brand_name.isBlank()) {
            JOptionPane.showMessageDialog(this, "Enter Category name", "Warning", JOptionPane.WARNING_MESSAGE);
        } else {
            try {
                if (jButton1.getText().equals("Add")) {
                    //Search if already Exists
                    ResultSet brs = MySQL.search("SELECT * FROM `category` WHERE `name` = '" + brand_name + "';");
                    //Search if already Exists
                    if (brs.next()) {
                        JOptionPane.showMessageDialog(this, "Category Already Exists", "Warning", JOptionPane.WARNING_MESSAGE);
                    } else {
                        MySQL.iud("INSERT INTO `category`(`name`) VALUES('" + brand_name + "');");
                        AddedSuccess as = new AddedSuccess(parent, false, "Category Added Successfully");
                        as.setVisible(true);
                        ...
                        jTextField1.setText("");
                        loadCategory();
                        this.ap.loadCategory();
                    }
                } else {
                    
                    MySQL.iud("UPDATE `category` SET `name`='" + brand_name + "' WHERE `id` = '" + toUpdate_id + "';");
                    AddedSuccess as = new AddedSuccess(parent, false, "Category Updated Successfully");
                    as.setVisible(true);
                    Runnable runnable = new Runnable() {
                        @Override
                        public void run() {
