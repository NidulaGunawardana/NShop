...
public class ReportType extends javax.swing.JDialog {
     ...
     */
    public ReportType(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ReportType(java.awt.Frame parent, boolean modal, StockReports sr, int ty) {
        super(parent, modal);
        initComponents();
        ImageIcon i = new ImageIcon("src/resources/logomain.png");
        Image x = i.getImage();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Excel (.xlsx)");
        jButton1.setToolTipText("Get a excel report");
        ...
        jButton2.setText("PDF (.pdf)");
        jButton2.setToolTipText("Get a PDF report");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (ty == 1) {
            this.sr.selectedStockReport();
        } else if (ty == 2) {
            this.sr.selectedStocks();
        } else if (ty == 3) {
            this.sr.allStocks();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (ty == 1) {
            this.sr.selectedStockpdf();
        } else if (ty == 2) {
            this.sr.selectedStockpdfs();
        } else if (ty == 3) {
            this.sr.selectedStockpdfall();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReportType dialog = new ReportType(new javax.swing.JFrame(), true);
